...
namespace DefenseSimulator.Controllers
{
    public class ResponsesController : Controller
    {
        ...
        public IActionResult Create(int? threatId)
        {
            if (threatId == null)
            {
                ViewBag.ResponseStatuses = EnumServices.GetEnumSelectList<ResponseStatus>();
            ...
            ViewBag.ResponseStatuses = EnumServices.GetEnumSelectList<ResponseStatus>();
            ViewBag.CounterTypes = EnumServices.GetEnumSelectList<CounterType>();
            SelectList threatIdList = new SelectList(_context.Threat.Where(m => m.ThreatId == threatId && m.IsActive), "ThreatId", "ThreatId");
            if (!threatIdList.Any())
            {
                return NotFound();
            }
            ViewData["ThreatId"] = threatIdList;
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ResponseId,ThreatId,LaunchTime,InterceptTime,ResponseType,Status")] Response response)
        {
            ModelState.Remove("Threat");
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ThreatId"] = new SelectList(_context.Threat, "ThreatId", "Origin", response.ThreatId);
            return View(response);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ResponseId,ThreatId,LaunchTime,InterceptTime,ResponseType,Status")] Response response)
        {
